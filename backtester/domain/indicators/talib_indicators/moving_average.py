...
for the Moving Average(SMA) indicator.
"""
...
@Indicator.register(name='MA')
class MovingAverage(TalibIndicator):
    """
       ...
       Methods:
           ...
           -> np.ndarray:
               Computes the SMA mask using the high,
               low,
               and close prices
    ...
    def _get_required_parameters(self) -> List:
        """
        Provide SMA's required parameters
        """
